...
class SendHistoryEntity {
     ...
     */
    public function __construct(string $id, string $customerId, string $takerEmail, string $currencyId, string $bankId, string $accountHolderName, string $iban, string $balance, string $createdAt, string $updatedAt) {
        $this->id = $id;
