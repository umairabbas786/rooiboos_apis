...
class UpdateDriverFcmTokenApiDoc extends ApiDoc {

    function onGeneralMeta() { ?>
        <div class="api-general-meta">
            <h2 class="api-title mt-5">Update Driver FCM Token</h2>
            <div class="api-meta">
                <p class="api-method">POST</p>
                <p class="end-point">update_driver_fcm_token.php</p>
            </div>
        </div>
    <?php }
    ...
    function onParamsDoc() { ?>
        <table class="table table-bordered params-table">
            ...
            <tr>
                <td class="gravity-center">fcm_token</td>
                <td class="gravity-center">String</td>
                <td class="gravity-center">True</td>
                <td> ----------- </td>
                <td>FCM Token value generated by firebase cloud messaging service</td>
            </tr>
        </table>
    <?php }
    ...
    function onResponseDoc() { ?>
        ...
        <p class="mt-4">Following response comes if FCM token is updated or not. <span class="param">true</span> if updated else <span class="param">false</span></p>
        <pre class="response-box"><code class="language-json kill-as-bad-request <?php $this->getUniqueClass() ?>"></code></pre>
        <script>
            document.querySelector('.<?php $this->getUniqueClass(); ?>').innerHTML = JSON.stringify({
