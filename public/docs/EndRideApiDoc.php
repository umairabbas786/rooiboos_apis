...
class EndRideApiDoc extends ApiDoc {

    function onGeneralMeta() { ?>
        <div class="api-general-meta">
            <h2 class="api-title mt-5">End Ride</h2>
            <div class="api-meta">
                <p class="api-method">POST</p>
                <p class="end-point">end_ride.php</p>
            </div>
        </div>
    <?php }
    ...
    function onResponseDoc() { ?>
        ...
        <p class="mt-4">Following response comes when state is updated successfully,
            <span class="param">bill_sent</span> this will be <span class="param">True</span> if the fcm token of client and driver was set,
            and then it depends on the response from fcm services, if they sent it will be true else in other situations it will remain
            <span class="param">False</span></p>
        <pre class="response-box"><code class="language-json kill-as-bad-request <?php $this->getUniqueClass() ?>"></code></pre>
        <script>
            document.querySelector('.<?php $this->getUniqueClass(); ?>').innerHTML = JSON.stringify({
